...
sender1.message6 = "Good. So, obviously you don't want Nova to find out about what you discovered, or even your new employer, right? Because what you found can only be accessed by hacking the system and you might have hacked your crime coefficient to always look clean but if they find you out it's treason.";
sender1.message7 = "I am part of UN-ABLE, do you know us?";
sender1.message8 = "Nope, we real, girl! We took out our implant because we didn't want everything we see, say or do to be recorded. Soon after we found out about the same thing that you just discovered. And now we need someone on the inside to get more info so we can convince everyone that NovaCorp and the Government are using us.";
...
sender2.answer9 = "Are they not worried about leaks if they do that with every intern?";
